...
async fn test_deepseek_chat_completion() {
    ...
    let msg = wild_agent_os_core::gateway::unified_gateway::ChatMessage {
        role: "user".to_string(),
        content: wild_agent_os_core::gateway::unified_gateway::ChatContent::Text(
            "Say 'Hello from Agent OS' and nothing else.".to_string(),
        ),
        name: None,
        tool_calls: None,
        tool_call_id: None,
...
async fn test_deepseek_sa_workflow() {
    ...
    let msg = wild_agent_os_core::gateway::unified_gateway::ChatMessage {
        role: "user".to_string(),
        content: wild_agent_os_core::gateway::unified_gateway::ChatContent::Text(
            "Classify this task as simple, standard, or emergency: \
